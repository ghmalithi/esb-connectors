...
public class JiraRestClient {
    ...
    private JSONObject sendRequestWithContent(String resource, String query,String method) throws IOException, JSONException {
        ...
        for(Object headerKey : map.keySet()){
            if(headerKey!=null){
                List header = (List)map.get(headerKey);
                headers.put((String)headerKey,header.get(0));
            }
        }
        ...
        jsonObject.put("httpsc",responseCode);
        jsonObject.put("response",new JSONObject(out));
